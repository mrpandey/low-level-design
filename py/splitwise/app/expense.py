...
from .ledger import Person, Split
...
class EqualExpense(Expense):
    ...
    def split(self) -> List[Split]:
        ...
        for person in self.split_among:
            ...
            split_list.append(Split(self.paid_by, person, split_amount))
    ...
    def split(self) -> List[Split]:
        ...
        for i, percent_share in enumerate(self.split_among):
            ...
            if self.paid_by is not percent_share.person:
                split_list.append(
                    Split(self.paid_by, percent_share.person, person_amount)
                )
...
class ExactExpense(Expense):
    ...
    def split(self) -> List[Split]:
        ...
        for exact_share in self.split_among:
            split_list.append(
                Split(self.paid_by, exact_share.person, exact_share.share)
            )
